...
public class form_tagihan extends javax.swing.JFrame {
  ...
  private String status;
    ...
    private void initComponents() {
        ...
        txt_id_transaksi.setBounds(530, 363, 330, 58);
        ...
        combo_idPeng.setBounds(962, 363, 330, 60);
        ...
        txt_nokamar.setBounds(530, 470, 330, 58);
        ...
        txt_bayar.setBounds(530, 578, 330, 56);
        ...
        txt_hargaKamar.setBounds(962, 470, 330, 58);
        ...
        txt_status.setBounds(1395, 578, 330, 56);
        ...
        txt_nama.setBounds(1395, 363, 330, 58);
        ...
        txt_sisa.setBounds(962, 578, 330, 56);
        ...
        jScrollPane1.setBounds(890, 717, 480, 110);
        ...
        btn_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hover_tagihan/btn tambah normal.png"))); // NOI18N
        ...
        btn_simpan.setBounds(1020, 880, 230, 53);

        lblnama4.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 24)); // NOI18N
        lblnama4.setForeground(new java.awt.Color(153, 153, 153));
        lblnama4.setText(".");
        getContentPane().add(lblnama4);
        lblnama4.setBounds(1750, 40, 130, 40);
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/form_tagihan.png"))); // NOI18N
        getContentPane().add(bg);
        bg.setBounds(0, 0, 1920, 1080);

        txt_id_bantu.setText("jLabel1");
        getContentPane().add(txt_id_bantu);
        txt_id_bantu.setBounds(1710, 260, 34, 14);
    ...
    private void btn_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseClicked
        ...
        try{
            ...
            String sql = "INSERT INTO tb_tagihan VALUES ('"+txt_id_transaksi.getText()
                    +"','"+combo_idPeng.getSelectedItem()+"','"+txt_nokamar.getText()
                    +"','"+tanggal+"','"+reFormat(txt_bayar.getText())+"','"
                    +reFormat(txt_sisa.getText())+"','"+txt_status.getText()+"','"
                    +txt_keterangan.getText()+"','"+txt_id_bantu.getText()+"')";
            ...
            JOptionPane.showMessageDialog(null, "Data gagal ditambahkan, Mohon cek"
    ...
    private void combo_idPengActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_idPengActionPerformed
        ...
        try{
            ...
            System.out.println(formatDec(harga));
...
//            txt_sisa.setText(String.valueOf(sisa));
            ...
            if (sisa > 0) {
                ...
                JOptionPane.showMessageDialog(null, "Uang yang anda masukkan melebihi batas");
                txt_bayar.setText("");
                txt_status.setText("");
                txt_sisa.setText("");
            }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        setExtendedState(form_tagihan.MAXIMIZED_BOTH);
    }//GEN-LAST:event_formWindowOpened

    private void btn_simpanMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseEntered
        btn_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hover/btn tambah entered.png")));
    ...
    private void btn_simpanMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseExited
        btn_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hover/btn tambah normal.png")));
    ...
    private void btn_simpanMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMousePressed
        btn_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hover/btn tambah press.png")));
    ...
    public static final javax.swing.JLabel bg = new javax.swing.JLabel();
    ...
    public static final javax.swing.JLabel lblnama4 = new javax.swing.JLabel();
